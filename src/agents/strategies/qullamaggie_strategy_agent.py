...
class QullamaggieStrategyAgent(BaseHedgeFundAgent):
    ...
    def __init__(self, account_size: float = 100000, **kwargs):
        # Set account_size first so it's available during initialization
...
Focus on mechanical rule execution with comprehensive risk management."""
        ...
        super().__init__(
            ...
            description="Qullamaggie momentum strategy agent specializing in breakouts, episodic pivots, and parabolic shorts",
            **kwargs
        )
